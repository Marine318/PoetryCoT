...
model_checkpoint = "../Model_pre/InternVL3-8B-hf"
...
def main():
    input_file = "../COT_0423/test.jsonl"    # Input dataset for prediction
    output_file = "../internvl3bhf_output_test_nocot.jsonl"    # Output file in JSON Lines format
