...
model = MllamaForConditionalGeneration.from_pretrained(
    "/root/autodl-tmp/LLaMA-Factory/Model_pre/Llama-3.2-11B-Vision-Instruct",
    torch_dtype=torch.bfloat16,
    device_map="auto"
)
processor = AutoProcessor.from_pretrained("/root/autodl-tmp/LLaMA-Factory/Model_pre/Llama-3.2-11B-Vision-Instruct")
tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/LLaMA-Factory/Model_pre/Llama-3.2-11B-Vision-Instruct")
...
def main(batch_size = 8):
    ...
    output_file = "/root/autodl-tmp/LLaMA-Factory/AnomalyCoT_output/llama_3.2_vision_pre.jsonl"
